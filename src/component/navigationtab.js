  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <div className="theme-content false" itemProp="mainEntityOfPage">
          <h2 style={{ textAlign: "left", fontFamily: "Abril Fatface", fontWeight: "1000", fontStyle: "normal" }}
            className="vc_custom_heading">MID BRAIN ACTIVATION (5-15 YEAR)</h2>
          <div className=" vc_custom_1545978429539">
          ...
          <div className=" vc_custom_1545977985150">
            <div id="text-block-6" className="mk-text-block   ">
              ...
              <p>The ideal age for the midbrain activation training for the children is 5 years old to 15 years old because they are open to absorb new things and also can easily adapt to new ways of learning</p>
              <div className="clearboth"></div>
            </div>
          </div>
      ...
      <TabPanel value={value} index={1}>
        <div className="theme-content1 false">
          <h2 style={{ textAlign: "left", fontFamily: "Abril Fatface", fontWeight: "1000", fontStyle: "normal" }}>Company Profile</h2>
          <p></p>
